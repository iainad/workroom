...
final class TerminalLinksTests: XCTestCase {
  ...
  func testTopLeftMapsToRowZero() {
    ...
    let hit = TerminalLinks.screenCell(
      forMouse: CGPoint(x: 1, y: 159), bounds: bounds, cell: cell, cols: 10, rows: 10)
  ...
  func testInteriorCell() {
    ...
    let hit = TerminalLinks.screenCell(
      forMouse: CGPoint(x: 12, y: 140), bounds: bounds, cell: cell, cols: 10, rows: 10)
  ...
  func testBottomRightCorner() {
    ...
    let hit = TerminalLinks.screenCell(
      forMouse: CGPoint(x: 79, y: 1), bounds: bounds, cell: cell, cols: 10, rows: 10)
  ...
  func testPointBeyondGridIsNil() {
    ...
    XCTAssertNil(
      TerminalLinks.screenCell(
        forMouse: CGPoint(x: 80, y: 80), bounds: bounds, cell: cell, cols: 10, rows: 10))
  }
  ...
  func testDegenerateCellSizeIsNil() {
    ...
    XCTAssertNil(
      TerminalLinks.screenCell(
        forMouse: CGPoint(x: 4, y: 80), bounds: bounds, cell: .zero, cols: 10, rows: 10))
  }
}
